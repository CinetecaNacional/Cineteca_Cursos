<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    ...
    <li class="nav-item">
      <a class="nav-link" href="./cursos_usuario.php">Mis cursos</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="./datos_usuario.php">Mis datos</a>
    </li>';
    }
      if (isset($_SESSION['tipo_usuario'])){
        if($_SESSION['tipo_usuario']=='Administrador principal'){
          ...
          <li class="nav-item">
            <a class="nav-link" href="./descuento.php">Descuentos</a>
          </li>
          <li class="nav-item">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="modal-footer">
                  <button id="btn_registro" type="submit" class="btn btn-success">Aceptar</button>
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                </div>
              </form>
            </div>
    ...
    if (isset($_SESSION['tipo_usuario'])){
      echo '
      <div class="my-2 my-lg-0">
      <button type="button" class="btn btn-outline-primary" name="button"><a href="../ajax/usuario.php?op=salir">Cerrar sesión</a></button>
      </div>';
    }
    ?>
  </div>
